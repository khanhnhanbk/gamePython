...
from pygame.constants import K_KP_ENTER, K_LEFT, K_RIGHT, K_SPACE, K_a, K_c, K_h, K_q, K_s
                ...
                for b in self.man.bullets:
                    if enemy.hitAnother(b):
                        ...
                        if enemy.isDead() and (enemy in self.enemys):
                            ...
                            self.man.health += enemy.maxHealth // 10 + 1
                ...
                for i in range(self.numberOfEnemy):
                    self.enemys.append(
                        player.Player(
                            ...
                            round(10 * 1.2 ** self.level),
                            "enemy",
                        )
                    )
                    self.enemys[i].dam = 1 + self.level // 10
